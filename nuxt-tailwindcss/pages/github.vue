  ...
  <div class="text-gray-900 text-sm">
    ...
    >
      <div class="flex items-center space-x-4">
        ...
        <ul class="hidden lg:flex ul items-center font-semibold space-x-4">
      ...
      <div class="flex items-center space-x-4 text-white">
        ...
        <a href="#" class="flex items-center hover:text-gray-400">
          <img
            ...
            src="https://avatars.githubusercontent.com/u/54740727?s=60&v=4"
            alt="avatar"
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <div class="flex">
        ...
        <div class="flex text-xl ml-2">
          <a href="#" class="text-blue-600 hover:underline font-semibold ml-1"
            >tailwindcss
          </a>
          <span class="ml-1">/</span>
          <div class="text-blue-600 hover:underline font-semibold ml-1">
            tailwindcss
          </div>
        </div>
      </div>
      <div class="flex space-x-2 text-xs mt-4 lg:mt-0">
        <div class="flex">
          <button
          ...
          <a
            href="#"
            class="border border-gray-400 rounded rounded-l-none border-l-0 px-3 py-1 hover:text-blue-600 font-semibold"
            >430
          </a>
        </div>
        <div class="flex">
    ...
    <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
      ...
      <li class="font-semibold">
        ...
        >
          <svg class="w-4 fill-current" aria-hidden="true" viewBox="0 0 16 16">
            <path
              fill-rule="evenodd"
          ...
          <span class="ml-1 bg-gray-300 px-2 text-gray-600 rounded-lg text-xs">
            106
          </span>
        </a>
      </li>
      ...
      <li class="hidden displa font-semibold">
        <a
          href="#"
          class="hidden lg:flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3"
        >
          <svg aria-hidden="true" viewBox="0 0 16 16" class="w-4 fill-current">
            <path
              fill-rule="evenodd"
    ...
    <div class="container mx-auto my-8 px-4 flex flex-col lg:flex-row">
      <div class="file-explorer-container w-full lg:w-3/4 lg:mr-8">
        <div class="branch-nav flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <button
              class="border border-gray-400 rounded-md px-4 py-1 hover:bg-gray-200 items-center space-x-2 flex"
            >
              <svg
            ...
            <a
              href="#"
              class="hidden lg:flex items-center space-x-2 space-x-1 group"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 16 16"
                class="fill-current text-gray-400 w-4 group-hover:text-blue-600"
              >
                <path
                  fill-rule="evenodd"
                  d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z"
            ...
            <a href="#" class="hidden lg:flex items-center space-x-1 group">
              <svg
                aria-hidden="true"
                viewBox="0 0 16 16"
                class="fill-current text-gray-400 w-4 group-hover:text-blue-600"
              ...
              <span class="group-hover:text-blue-600">
                <span class="font-semibold">151 </span>
          ...
          <div class="items-center space-x-2 hidden lg:flex">
            <button
              class="border border-gray-400 px-4 py-1 rounded-md flex items-center space-x-2 hover:bg-gray-200"
            >
            ...
            <button
              class="border border-green-400 bg-green-500 px-4 py-1 rounded-md text-white flex items-center space-x-2 hover:bg-green-400"
            >
              <svg
                class="fill-current w-4 text-white"
                viewBox="0 0 16 16"
                aria-hidden="true"
              >
                <path
        ...
        >
          <div class="flex space-x-2 items-center">
            ...
            <a href="#" class="hover:text-blue-600">1.5.1</a>
          </div>
          ...
          <div class="flex items-end">
            ...
            <a
              href="#"
              class="hidden lg:inline font-mono text-xs text-gray-600 hover:underline hover:text-blue-500 ml-2"
            >
              da070bd
            </a>
            <a
              href="#"
              class="text-gray-600 hover:underline hover:text-blue-500 ml-2"
            >
              4 days ago
            </a>
        ...
        <div
          class="file-explorer rounded-md rounded-t-none border border-gray-300 text-gray-700 divide-y divide-gray-300"
        >
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12">
              <div class="flex items-center space-x-2">
                <svg
                  ...
                  aria-hidden="true"
                  viewBox="0 0 16 16"
                  class="w-4 fill-current text-blue-300"
                >
                  <path
                    fill-rule="evenodd"
            ...
            <div class="hidden lg:block w-6/12">Update issues template</div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="hidden lg:block w-6/12">Remove stale test</div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="4/12 lg:w-2/12 text-right">15 months ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12">
              <div class="flex items-center space-x-2">
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="hidden lg:block w-6/12">
              Only wrap with variants for container by default
            </div>
            <div class="w-2/12 text-right">4 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12">
              <div class="flex items-center space-x-2">
                ...
                <span> .eslintignore </span>
              </div>
            </div>
            <div class="hidden lg:block w-6/12">Updated CLI init command</div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="hidden lg:blockw-6/12">
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="hidden lg:block w-6/12 truncate">
              Add new `plugin` and `plugin.withOptions` functions for creating
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Exercitationem facilis placeat amet rerum voluptatem fugiat error
              dicta qui quod reprehenderit natus fuga, iste, iure temporibus
              sint, numquam porro consequatur libero?
            </div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="hidden lg:block w-6/12">Add alt attribute to logo</div>
      ...
      <div class="sidebar w-full lg:w-1/4 mt-4 lg:mt-0">
        <div class="about">
          ...
          <a
            href="#"
            class="flex items-center space-x-2 mt-4 group text-gray-600"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 16 16"
              class="w-4 fill-current group-hover:text-blue-600"
            >
              <path
                fill-rule="evenodd"
          ...
          <div class="releases border-t border-gray-400 mt-6 pt-6">
            ...
            <a href="#" class="flex mt-4 group items-start">
              <svg
                aria-hidden="true"
                viewBox="0 0 16 16"
                class="w-4 fill-current mt-1 text-green-500 group-hover:text-blue-500"
              >
                <path
                  fill-rule="evenodd"
                  d="M2.5 7.775V2.75a.25.25 0 01.25-.25h5.025a.25.25 0 01.177.073l6.25 6.25a.25.25 0 010 .354l-5.025 5.025a.25.25 0 01-.354 0l-6.25-6.25a.25.25 0 01-.073-.177zm-1.5 0V2.75C1 1.784 1.784 1 2.75 1h5.025c.464 0 .91.184 1.238.513l6.25 6.25a1.75 1.75 0 010 2.474l-5.026 5.026a1.75 1.75 0 01-2.474 0l-6.25-6.25A1.75 1.75 0 011 7.775zM6 5a1 1 0 100 2 1 1 0 000-2z"
              ...
              <span class="group-hover:text-blue-500 ml-2">
                <span class="font-semibold hover:text-blue-600">1.5.1</span>
                <span
            ...
            <div class="mt-3">
              <a
                href="/tailwindlabs/tailwindcss/releases"
          ...
          <div class="used-by border-t border-gray-400 mt-6 pt-6">
            <h4 class="flex items-center text-base font-semibold">
              <span>Used by</span>
              <div class="text-xs rounded-lg bg-gray-300 px-2 ml-1">192k</div>
            </h4>
            ...
            <a href="#" class="flex items-center justify-between">
              <div class="flex mt-4 -space-x-2">
                <img
                  src="https://avatars.githubusercontent.com/u/54740727?s=60&v=4"
                  alt="avatar"
                  class="rounded-full border border-white w-8"
                />
                <img
                  src="https://avatars.githubusercontent.com/u/54740727?s=60&v=4"
                  alt="avatar"
              ...
              <span class="text-xs text-blue-600 hover:underline mt-4 mr-5">
                + 192,481
              </span>
            </a>
          </div>
          ...
          <div class="contributors border-t border-gray-400 mt-6 pt-6">
            <h4 class="flex items-center text-base font-semibold">
              ...
              <div class="text-xs rounded-lg bg-gray-300 px-2 ml-1">171</div>
            </h4>

            <div class="flex items-center flex-wrap mt-4">
              <a href="#" class="mb-2 mr-2">
                <img
                  src="https://avatars.githubusercontent.com/u/54740727?s=60&v=4"
                  alt="avatar"
                  class="rounded-full border border-white w-8"
    ...
    <footer
      class="container mx-auto border-t border-gray-400 flex flex-col lg:flex-row text-xs py-10 items-center justify-between"
    >
      ...
      <div class="mx-16 hidden lg:block">
        <svg
          height="24"
          class="w-5 fill-current text-gray-400"
          viewBox="0 0 16 16"
          aria-hidden="true"
        >
          <path
